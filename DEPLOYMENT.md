...
- [ ] Backup current AjixPharmacy/data/ folder
...
# OR
heroku deploy --source-dir=AjixPharmacy/backend
```
...
cd your-repo/AjixPharmacy/backend
npm install
```
...
- Select backend folder: `AjixPharmacy/backend`
...
mkdir -p ~/backups
cp -r ~/your-repo/AjixPharmacy/backend/data ~/backups/data_$TIMESTAMP
