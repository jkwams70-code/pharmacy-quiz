...
const CASE_DEFINITIONS = [
  {
    caseId: "gppqe-2024-case-1-thyroid",
    heading: "## CASE 1: Mr. KE - Thyroid Disorder",
    rangeStart: 61,
    rangeEnd: 70,
    questionMarker: "**61.",
  },
  {
    caseId: "gppqe-2024-case-2-pneumonia",
    heading: "## CASE 2: Amah - Bacterial Pneumonia",
    rangeStart: 71,
    rangeEnd: 80,
    questionMarker: "**71.",
  },
  {
    caseId: "gppqe-2024-case-3-hypoglycemia-pesticide",
    heading: "## CASE 3: Mr. AT - Hypoglycemia and Pesticide Poisoning",
    rangeStart: 81,
    rangeEnd: 90,
    questionMarker: "**81.",
  },
  {
    caseId: "gppqe-2024-case-4-fee-dispute",
    heading: "## CASE 1: Mr. Sammy - Pharmacy Proprietor and Pharmacist Fee Dispute",
    rangeStart: 131,
    rangeEnd: 140,
    questionMarker: "**131.",
    stopBeforeSummary: true,
    summaryMarker: "Use the answer code summary to answer questions 131-140",
  },
  {
    caseId: "gppqe-2024-case-5-emergency-response",
    heading: "## CASE 2: FIP and PSGH Emergency Response",
    rangeStart: 141,
    rangeEnd: 150,
    questionMarker: "**141.",
  },
...
async function main() {
  ...
  if (!inputPath) {
    throw new Error("Usage: node scripts/import-gppqe-2024.mjs <path-to-pasted-text.txt>");
  }
  ...
  const cleanedExisting = existing.filter(
    (question) =>
      !(
        ...
        String(question?.sourceTag || "") === "gppqe-2024"
      ),
  );
  ...
  console.log(
    `Imported ${reindexedQuestions.length} GPPQE 2024 items into backend/data/questions.json and data/questions.json.`,
  );
}
